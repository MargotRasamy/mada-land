export function notificationsReducer(state, action) {
    switch (action.type) {
        case "ADD_NOTIFICATION":
            return { ...state, notifications: {...state.notifications, notificationsData: [...state.notifications.notificationsData, {...action.payload, index: state.notifications.notificationsData.length}]} };
